...
@Component({
  selector: 'app-list-cartoon-detail',
  templateUrl: './list-cartoon-detail.page.html',
  styleUrls: ['./list-cartoon-detail.page.scss'],
})
export class ListCartoonDetailPage implements OnInit {
