...
@Component({
  selector: 'app-list-romantic-detail',
  templateUrl: './list-romantic-detail.page.html',
  styleUrls: ['./list-romantic-detail.page.scss'],
})
export class ListRomanticDetailPage implements OnInit {
