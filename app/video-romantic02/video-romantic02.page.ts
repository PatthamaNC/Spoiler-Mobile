...
@Component({
  selector: 'app-video-romantic02',
  templateUrl: './video-romantic02.page.html',
  styleUrls: ['./video-romantic02.page.scss'],
})
export class VideoRomantic02Page implements OnInit {
