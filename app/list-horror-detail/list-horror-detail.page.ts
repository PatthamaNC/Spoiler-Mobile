...
@Component({
  selector: 'app-list-horror-detail',
  templateUrl: './list-horror-detail.page.html',
  styleUrls: ['./list-horror-detail.page.scss'],
})
export class ListHorrorDetailPage implements OnInit {
