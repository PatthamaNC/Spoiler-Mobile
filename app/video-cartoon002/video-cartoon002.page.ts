...
@Component({
  selector: 'app-video-cartoon002',
  templateUrl: './video-cartoon002.page.html',
  styleUrls: ['./video-cartoon002.page.scss'],
})
export class VideoCartoon002Page implements OnInit {
